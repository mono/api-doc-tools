...
namespace Mono.Documentation
{
	...
	class AssemblySet : IDisposable
	{
		...
		string importPath;
		public DocumentationImporter Importer { get; private set; }
		...
		public AssemblySet (string name, IEnumerable<string> paths, IEnumerable<string> resolverSearchPaths, string import)
		{
			Name = name;
			...
			if (!string.IsNullOrWhiteSpace (this.importPath)) {
				this.Importer = MDocUpdater.Instance.GetImporter(this.importPath);
			}
		}
