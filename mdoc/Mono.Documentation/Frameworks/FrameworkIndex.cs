...
namespace Mono.Documentation
{
	...
	class FrameworkIndex
	{
		...
		public FrameworkEntry StartProcessingAssembly (AssemblyDefinition assembly, DocumentationImporter importer) 
		{
			...
			if (entry == null) {
				entry = new FrameworkEntry (frameworks) { Name = shortPath, Importer = importer };
